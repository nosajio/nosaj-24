...
import swift from "./assets/tailwind/tw-swift.png";
...
I've gone down the rabbithole with SASS, Less, PostCSS... and then there was the phase of using inline styles (that's right). I've embodied BEM, loved Styled Components for a while, and then Vanilla Extract.
...
<picture>
  ...
  <img {...leapsLight} alt="How to add a style in CSS vs Tailwind" />
</picture>
